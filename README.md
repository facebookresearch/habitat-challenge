...
1. **Minival RGB phase**: consists of 30 episodes with RGB modality. This split is same as the one used in `./test_locally_rgb.sh`. Each team is allowed maximum of 1 submission per day for this phase.
...
1. **Test Standard RGB phase**: consists of 1000 episodes with RGB modality. Each team is allowed maximum of 1 submission per day for this phase
1. **Test Standard RGBD phase**: consists of same episodes as Test Standard RGB phase with RGB-Depth modality. Each team is allowed maximum of 1 submission per day for this phase.
